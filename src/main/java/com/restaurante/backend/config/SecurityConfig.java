...
import com.restaurante.backend.security.TenantFilter;
import com.restaurante.backend.security.UserDetailsServiceImpl;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/tenants/public/info").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Use patterns to support subdomains easily
